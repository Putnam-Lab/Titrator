...
path<-"Data/Bailout_BlueTank_Titrations/20210404/" #the location of all your titration files, your folder of the day!
massfile<-"Mass_20210404.csv" # name of your file with masses
titrationfile<-'Titrations-4_4_2021-PutnamLab.csv'# name of the last titration file run
