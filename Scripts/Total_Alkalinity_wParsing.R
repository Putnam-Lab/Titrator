...
## <<<<<<< HEAD
massfile<-"Mass_20240430_samples.csv" # name of your file with masses
titrationfile<-'20240430_cbls_samples.csv'# name of the last titration file run
date<-'20240430' #date that data was run
path<-"../Data/BlueTank_Titrations/20240430/" #the location of all your titration files, your folder of the day!
