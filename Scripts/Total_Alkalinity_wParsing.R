...
path<-"Data/BlueTank_Titrations/20220224" #the location of all your titration files, your folder of the day!
massfile<-"Mass_20220224.csv" # name of your file with masses
titrationfile<-'20220224_PutnamTitrations_PutnamLab.csv'# name of the last titration file run
