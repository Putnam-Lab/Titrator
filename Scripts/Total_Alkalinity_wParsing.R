...
path<-"Data/E5_Titrations/E5_2020_Calcification_Samples/20220323" #the location of all your titration files, your folder of the day!
massfile<-"Mass_Run3_20220323.csv" # name of your file with masses
titrationfile<-'20220323_Run3_PutnamLab.csv'# name of the last titration file run
