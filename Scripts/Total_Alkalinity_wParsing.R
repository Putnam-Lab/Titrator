...
## <<<<<<< HEAD
massfile<-"Mass_20250703_CRM.csv" # name of your file with masses
titrationfile<-'20250703_CBLS_CRM.csv'# name of the last titration file run
date<-'20250703' #date that data was run
path<-"Data/BlueTank_Titrations/20250703" #the location of all your titration files, your folder of the day!
