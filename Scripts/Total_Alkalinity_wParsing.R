...
path<-"Data/Bailout_BlueTank_Titrations/20210603/" #the location of all your titration files, your folder of the day!
massfile<-"Mass_20210603.csv" # name of your file with masses
titrationfile<-'Titrations-6_3_2021-PutnamLab.csv'# name of the last titration file run
