...
path<-"Data/E5_Titrations/E5_2020_Calcification_Samples/20220322" #the location of all your titration files, your folder of the day!
massfile<-"Mass_Run4_20220322.csv" # name of your file with masses
titrationfile<-'20220322_Run4_PutnamLab.csv'# name of the last titration file run
